...
public class createTableOfContentByDefault {
    public static void main(String[] args) {
        ...
        para1.appendText("万年青是一种小花。Ornithogalum is a genus of perennial plants mostly native to southern Europe and southern Africa belonging to the family Asparagaceae.");
        para1.appendText("\r\r"); //word 回车符 \r
        para1 = section.addParagraph();
        ...
        para2.appendText("玫瑰是一种常见的美丽花朵。A rose is a woody perennial flowering plant of the genus Rosa, in the family Rosaceae, or the flower it bears. There are over a hundred species and thousands of cultivars.");
        section.addParagraph();

        Paragraph para3 = section.addParagraph();
        //para3.appendText("Hyacinth");
        para3.appendText("风信子");
        ...
        para3.appendText("风信子是一种少见的花朵。Hyacinthus is a small genus of bulbous.");
        para3 = section.addParagraph();
        ...
        para3.appendText("\r\r\r\r\r\r\r\r\r"); //word 回车符 \r
        ...
        System.out.println(">>> create word is over.");
    }
}
